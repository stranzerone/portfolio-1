        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              // Text("ABOUT ME", style: style1),
              // SizedBox(height: 10),
              // Text(
              //   "Hello! I/'m Ayan a Flutter developer with a fully prepred with a app development skills,\n"
              //   "I'm passionate about leveraging technology to solve problems and create meaningful user experiences.",
              //   style: TextStyle(
              //       color: const Color.fromARGB(255, 184, 173, 70),
              //       fontSize: 15),
              // ),
              SizedBox(
                height: 60,
